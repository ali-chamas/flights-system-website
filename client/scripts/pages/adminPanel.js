...
const getUsers = () => {
  fetch(
    "http://localhost/flights-system-website/server/statistics/totalUsers.php",
    {
      method: "GET",
    }
  )
...
const getBookings = () => {
  fetch(
    "http://localhost/flights-system-website/server/statistics/totalBookings.php",
    {
      method: "GET",
    }
  )
...
const getRevenueAmount = () => {
  fetch(
    "http://localhost/flights-system-website/server/statistics/revenueAmount.php",
    {
      method: "GET",
    }
  )
