...
const getAllBookings = () => {
  fetch(
    "http://localhost/flights-system-website/server/bookings/updateBooking.php",
    {
      method: "GET",
    }
  )
...
const getCertainBooking = (id, newFlightStatus) => {
  fetch(
    `http://localhost/flights-system-website/server/bookings/updateBooking.php?id=${id}`,
    {
      method: "GET",
    }
  )
    ...
    .then((data) => {
      modifyStatusRequest(data.booking.ticketID, newFlightStatus);
    })
...
const modifyStatusRequest = (id, newFlightStatus) => {
  fetch(
    `http://localhost/flights-system-website/server/bookings/updateBooking.php?id=${id}&newSeatNumber=${newFlightStatus}`,
    {
      method: "POST",
    }
  )
